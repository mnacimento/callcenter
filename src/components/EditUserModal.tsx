...
import { User, UserUpdateInput } from '../interface/user.interface';
...
import { getAllUsers, updateUserService } from '../services/users/usersServices';
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                const fetchedRoles: User[] = await getAllUsers();
                dispatch(setUsers(fetchedRoles));
                onClose();
            } catch (error) {
